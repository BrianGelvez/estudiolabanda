      ...
      <div className="pt-24 pb-12">
        <div className="container mx-auto px-4">
          ...
          <div className="flex justify-center mb-12">
            <div className="glass-card rounded-full px-8 py-4">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            {currentStep === 1 && (
              <div>
                <Card className="glass-card rounded-2xl p-8 mb-8">
                    ...
                    {barbers.map((barber) => (
                      ...
                      >
                        <div className="text-center">
                          ...
                          <h3 className="font-bold text-lg mb-2 text-white">{barber.name}</h3>
                          <p className="text-primary text-sm mb-1">{barber.specialty}</p>
                          <p className="text-muted-foreground text-sm">{barber.experience}</p>
                        </div>
                      </Card>
                    ))}
                  </div>
                ...
                <div className="text-center">
                  <Button
                    ...
                    className="glass-button rounded-full px-8 py-3 text-lg font-medium"
                  >
                    Continuar
                  </Button>
                </div>
              ...
              <div>
                <Card className="glass-card rounded-2xl p-8 mb-8">
                  ...
                  <div className="max-w-md mx-auto">
                    <Label htmlFor="date" className="text-lg text-white mb-4 block">
                      Fecha de la cita
                    </Label>
                    <Input
                      id="date"
                      ...
                      className="glass text-lg p-4 rounded-xl text-white"
                    />
                  </div>
                </Card>
                <div className="flex justify-center gap-4">
                  <Button
                    onClick={handleBack}
                    variant="outline"
                    className="glass rounded-full px-6 py-3 bg-transparent border-primary/30"
                  >
                    Atrás
                  </Button>
                  <Button
            ...
            {currentStep === 3 && (
              <div>
                <Card className="glass-card rounded-2xl p-8 mb-8">
                  ...
                  {/* Time Selection */}
                  <div className="mb-8">
                    <Label className="text-lg mb-4 block text-white">Selecciona la hora</Label>
                    <div className="grid grid-cols-3 md:grid-cols-4 gap-3">
                      {timeSlots.map((time) => (
                        <Button
                          key={time}
                          variant={selectedTime === time ? "default" : "outline"}
                          className={`glass-button rounded-lg p-3 ${
                            selectedTime === time
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      <Label htmlFor="instagram" className="text-lg text-white">
                        Instagram (opcional)
                      </Label>
                      <Input
                        id="instagram"
            ...
            {currentStep === 4 && (
              <div className="text-center">
                <Card className="glass-card rounded-2xl p-8">
                  ...
                  <h2 className="text-4xl font-bold mb-4 text-white">¡Cita Confirmada!</h2>
                  <p className="text-muted-foreground mb-8 text-lg">Tu cita ha sido reservada exitosamente</p>

                  <div className="glass rounded-xl p-6 mb-8 text-left max-w-2xl mx-auto">
                    <h3 className="font-bold text-xl mb-4 text-primary">Detalles de tu cita:</h3>
                  ...
                  <div className="glass rounded-xl p-6 mb-8">
                    <h4 className="font-bold text-lg mb-2 text-primary">Información importante:</h4>
